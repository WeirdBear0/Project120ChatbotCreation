...
def bot_class_prediction(user_input):
    ...
    #prediction model for text meaning from ./chatbot_model.h5
    prediction = model.predict(inp)
    # from all the labels returned by model.predict they will be sorted in a list by accuracy greatest to least and index 0 is the best match
    predicted_class_label = np.argmax(prediction[0])
    #returning the label from line 54
